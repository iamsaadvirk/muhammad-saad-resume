...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_vp41m2r', 'template_xxbrraa', form.current, '6w16qbFg6tTe3knuK')
      e.target.reset()
  };
  return (
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        ...
                        <textarea name='project' cols='30' rows='10' className='contact__form-input' placeholder='Write your project details!'></textarea>
                    </div>

                    <button className="button button--flex"> Send project request!
                        <svg
