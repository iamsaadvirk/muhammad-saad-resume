...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">M. Saad Virk
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
        ...
        <p className="home__description">
            I'm a fullstack developer based in Lahore, Pakistan. I'm very passionate and dedicated to my work. 
        </p>

        <a href="#contact" className="button button--flex button-level"> Say Hello!
            <svg
                class="button__icon"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
