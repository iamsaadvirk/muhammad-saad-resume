                ...
                <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Pakistan - Ultimulti Solutions</span>
                            <div className="qualification__calender">
                                <UilCalendarAlt /> Nov 2019 - Aug 2020
                            </div>
                        </div>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <div className="qualification__calender">
                                <UilCalendarAlt /> Jun 2018 - Sep 2018
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">Back End Developer Intern</h3>
                            <span className="qualification__subtitle">Pakistan - Royal Soft</span>
                            <div className="qualification__calender">
                                <UilCalendarAlt /> May 2018 - Jun 2018
                            </div>
                        </div>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <div className="qualification__calender">
                                <UilCalendarAlt /> Apr 2018 - May 2018s
                            </div>
                        </div>
                    </div>
                </div>
